 ...
 * 
 * @author user
 *	스케쥴러 클래스 : 특정시간에 반복적으로 실행되는 클래스
 *	=> 공공데이터포털에서 10초마다 데이터를 받아 파일에 내용 쓰기
 * 참고) AI / 빅테이터 처리 : 1)수집 2)가공 3)적재(DB,파일 등)
 */
@Log4j2
@Component
public class PublicApiJob {
//		상수 정의
		final String serviceKey = "GezU%2FrTUboUpQX09iirTk44J75s2sSptkdZMcr0y9hmYTlLqYc3YUuTZQGcuNGDHp6Z0bfYw0%2FESGQHhWUfktw%3D%3D";	// 공공데이터 API 인증키
